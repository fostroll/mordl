...
class UposTagger(BaseTagger):
    ...
    def _predict(self, corpus=None, batch_size=32, split=None,
                 with_orig=False, log_file=LOG_FILE):
    ...
    def predict(self, corpus=None, batch_size=32, split=None, with_orig=False,
        ...
        corpus = self._predict(corpus=corpus, batch_size=batch_size,
                               split=split, with_orig=with_orig,
                               log_file=log_file)
        if save_to:
