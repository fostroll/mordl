...
class WordEmbeddings:
    ...
    def _full_tune(model, model_save_as, model_save_method,
        ...
        **log_file**: a stream for info messages. Default is `sys.stdout`.
        ...
        trainer_config = TrainerConfig(
            (save_as, model_save_as), max_epochs=max_epochs,
    ...
    def bert_tune(train_sentences, train_labels, test_data=None,
                  ...
                  save_to=None, max_len=512, max_epochs=3, batch_size=8,
        ...
        **max_epochs** (`int`): maximal number of finetuning epochs. Default
        `max_epochs=3`.
